                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-3 text-center">
                            <a href="index.php" class="btn btn-black fas fa-caret-square-left col-md-1 text-lift" style="font-size: 3.0em; "></a>
                        </div>
                        <h5 class="col-md-6 text-center">
                            แก้ไข
                        </h5>
                        <button class="btn btn-light fas fa-save col-md-1 text-lift" type="submit" style="font-size: 3.0em; "></button>
                        <?php                        
                        ?> 
                    </div>
                </div>
                        ...
                        <?php 
                            ...
                            while($row = $result->fetch_assoc()) {
                                ...
                                <div class="card-footer bg-transparent border-success text-center">
                                    <i data-bs-toggle="modal" data-bs-target="#content'. $row['number'] .'" class="fas fa-trash-alt col-md-1 text-center" style="font-size: 2.0em;color: blue; "></i>
                                </div>';
